...
describe 'Transferred Service Call Integration Spec' do
  ...
  context 'when transferred from a local provider' do
    ...
    context 'when I do the job' do

      context 'when allowing the collection' do
                ...
                context 'when I invoice' do
                  ...
                  context 'when I collect' do
                    ...
                    context 'when collecting cash' do
                      before do
                        job.update_attributes(billing_status_event: 'collect', payment_type: 'cash')
                      end
      ...
      context 'when not allowing the collection' do
        context 'when allowing to transfer' do
          include_context 'job transferred from a local provider' do
    ...
    context 'when I transfer to a local subcon' do
          ...
          context 'when accepting on behalf of the subcon' do
            ...
            context 'when started the work' do
              ...
              context 'when completed the job' do
                ...
                it 'the available payment events should be: invoice, invoiced by prov and invoiced by subcon' do
                  expect(job.billing_status_events).to eq [:invoice, :subcon_invoiced, :provider_invoiced]
                  expect(event_permitted_for_job?('billing_status', 'invoice', org_admin, job)).to be_true
                  expect(event_permitted_for_job?('billing_status', 'provider_invoiced', org_admin, job)).to be_true
    ...
    context 'when I transfer to a member subcon'
