...
describe BomsController do
  ...
  # Bom. As you add validations to Bom, be sure to
  ...
  # BomsController. Be sure to keep this updated too.
  def valid_session
    { }
  end

  describe "GET index" do
    it "assigns all boms as @boms" do
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bom" do
        bom = Bom.create! valid_attributes
        # Assuming there are no other boms in the database, this
        # specifies that the Bom created on the previous line
  ...
  describe "DELETE destroy" do
    it "destroys the requested bom" do
      bom = Bom.create! valid_attributes
      expect {
        delete :destroy, { :id => bom.to_param }, valid_session
      }.to change(Bom, :count).by(-1)
    end

    it "redirects to the boms list" do
      bom = Bom.create! valid_attributes
      delete :destroy, { :id => bom.to_param }, valid_session
      response.should redirect_to(boms_url)
    end
  end
