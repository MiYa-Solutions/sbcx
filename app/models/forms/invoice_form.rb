module Forms::InvoiceForm
  ...
  def generate_adv_payment
    entry = AdvancePayment.new(amount:      adv_payment_amount,
                               description: adv_payment_desc, ticket: self.invoiceable)
  ...
  def email_presence
    self.errors.add :email_customer, 'The customer does not have an email specified' if accountable.email.blank?
