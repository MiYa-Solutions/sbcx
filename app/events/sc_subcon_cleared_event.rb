class ScSubconClearedEvent < ScSettlementEvent
  ...
  def init
    ...
    self.description  = I18n.t('service_call_subcon_cleared_event.description', subcon: service_call.subcontractor.name, payment_type: service_call.provider_payment.classify.constantize.model_name.human, ref: service_call.ref_id)
